...
It is instead [Figtree](https://github.com/erikdkennedy/figtree) by Erik Kennedy, which I find fairly clean and its text readability on par with Inter. It looks very very good both as a header/title font (though I may change this eventually) and as a body font.
